...
export const de: Dictionary = {
  ...
  award: {
    ...
    close: "Auszeichnung schließen",
    previous: "Vorheriger Jahrgang",
    next: "Nächster Jahrgang",
    certificateAlt:
      "Zertifikat Booking.com Traveller Review Awards {year} für Domeček Janov, Bewertung {score} von 10",
  },
  tour: {
